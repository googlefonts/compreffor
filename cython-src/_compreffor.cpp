...
#include "stdio.h"
#include "pythread.h"
#include "../cxx-src/cffCompressor.h"
#include "ios"
#include "new"
#include "stdexcept"
#include "typeinfo"
...
static arrayobject *__pyx_v_10compreffor_11_compreffor_array_template = 0;
...
static const char __pyx_k_Users_cosimolupo_Documents_Gith[] = "/Users/cosimolupo/Documents/Github/compreffor/cython-src/_compreffor.pyx";
static PyObject *__pyx_n_s_I;
static PyObject *__pyx_n_s_MemoryError;
static PyObject *__pyx_kp_s_Users_cosimolupo_Documents_Gith;
static PyObject *__pyx_n_s_array;
static PyObject *__pyx_n_s_compreff;
static PyObject *__pyx_n_s_compreffor__compreffor;
static PyObject *__pyx_n_s_dataStream;
static PyObject *__pyx_n_s_i;
static PyObject *__pyx_n_s_import;
static PyObject *__pyx_n_s_main;
static PyObject *__pyx_n_s_numRounds;
static PyObject *__pyx_n_s_output;
static PyObject *__pyx_n_s_outputLength;
...
/* Python wrapper */
static PyObject *__pyx_pw_10compreffor_11_compreffor_1compreff(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_10compreffor_11_compreffor_1compreff = {"compreff", (PyCFunction)__pyx_pw_10compreffor_11_compreffor_1compreff, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_10compreffor_11_compreffor_1compreff(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_dataStream,&__pyx_n_s_numRounds,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_dataStream)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_numRounds)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("compreff", 1, 2, 2, 1); __PYX_ERR(0, 16, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "compreff") < 0)) __PYX_ERR(0, 16, __pyx_L3_error)
      }
    ...
    __pyx_v_numRounds = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_numRounds == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("compreff", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 16, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("compreffor._compreffor.compreff", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_dataStream), (&PyBytes_Type), 1, "dataStream", 1))) __PYX_ERR(0, 16, __pyx_L1_error)
 ...
 *     cdef unsigned i
 */
  __pyx_t_1 = __Pyx_PyObject_AsUString(__pyx_v_dataStream); if (unlikely((!__pyx_t_1) && PyErr_Occurred())) __PYX_ERR(0, 18, __pyx_L1_error)
  try {
 ...
 */
  __pyx_t_3 = ((PyObject *)__pyx_v_10compreffor_11_compreffor_array_template);
  __Pyx_INCREF(__pyx_t_3);
  __pyx_t_4 = ((PyObject *)__pyx_f_7cpython_5array_clone(((arrayobject *)__pyx_t_3), __pyx_v_outputLength, 0)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_output = ((arrayobject *)__pyx_t_4);
  __pyx_t_4 = 0;

  /* "cython-src/_compreffor.pyx":21
 *     cdef array.array output = array.clone(array_template, outputLength, zero=False)
 *     cdef unsigned i
 *     for i in range(outputLength):             # <<<<<<<<<<<<<<
 ...
 *     if raw_output != NULL:
 */
  __pyx_t_5 = __pyx_v_outputLength;
  for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
    __pyx_v_i = __pyx_t_6;

    /* "cython-src/_compreffor.pyx":22
 *     cdef unsigned i
 *     for i in range(outputLength):
 *         output[i] = raw_output[i]             # <<<<<<<<<<<<<<
 *     if raw_output != NULL:
 *         unload(raw_output)
 */
    __pyx_t_4 = __Pyx_PyInt_From_uint32_t((__pyx_v_raw_output[__pyx_v_i])); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 22, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    if (unlikely(__Pyx_SetItemInt(((PyObject *)__pyx_v_output), __pyx_v_i, __pyx_t_4, unsigned int, 0, __Pyx_PyInt_From_unsigned_int, 0, 0, 1) < 0)) __PYX_ERR(0, 22, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  }

  /* "cython-src/_compreffor.pyx":23
 *     for i in range(outputLength):
 *         output[i] = raw_output[i]
 *     if raw_output != NULL:             # <<<<<<<<<<<<<<
 *         unload(raw_output)
 *     return output
 */
  __pyx_t_7 = ((__pyx_v_raw_output != NULL) != 0);
  if (__pyx_t_7) {

    /* "cython-src/_compreffor.pyx":24
 *         output[i] = raw_output[i]
 *     if raw_output != NULL:
 *         unload(raw_output)             # <<<<<<<<<<<<<<
 *     return output
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_Users_cosimolupo_Documents_Gith, __pyx_k_Users_cosimolupo_Documents_Gith, sizeof(__pyx_k_Users_cosimolupo_Documents_Gith), 0, 0, 1, 0},
 ...
 *     cdef uint32_t* raw_output = _compreff(dataStream, numRounds, outputLength)
 */
  __pyx_tuple_ = PyTuple_Pack(6, __pyx_n_s_dataStream, __pyx_n_s_numRounds, __pyx_n_s_outputLength, __pyx_n_s_raw_output, __pyx_n_s_output, __pyx_n_s_i); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple_);
  __Pyx_GIVEREF(__pyx_tuple_);
  __pyx_codeobj__2 = (PyObject*)__Pyx_PyCode_New(2, 0, 6, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple_, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_cosimolupo_Documents_Gith, __pyx_n_s_compreff, 16, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__2)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_compreffor(void); /*proto*/
PyMODINIT_FUNC init_compreffor(void)
#else
PyMODINIT_FUNC PyInit__compreffor(void); /*proto*/
PyMODINIT_FUNC PyInit__compreffor(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__compreffor(void)", 0);
  ...
  /*--- Global init code ---*/
  __pyx_v_10compreffor_11_compreffor_array_template = ((arrayobject *)Py_None); Py_INCREF(Py_None);
 ...
 */
  ...
  __Pyx_XGOTREF(((PyObject *)__pyx_v_10compreffor_11_compreffor_array_template));
  __Pyx_DECREF_SET(__pyx_v_10compreffor_11_compreffor_array_template, ((arrayobject *)__pyx_t_1));
  __Pyx_GIVEREF(__pyx_t_1);
  __pyx_t_1 = 0;
 ...
 *     cdef uint32_t* raw_output = _compreff(dataStream, numRounds, outputLength)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_10compreffor_11_compreffor_1compreff, NULL, __pyx_n_s_compreffor__compreffor); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_compreff, __pyx_t_1) < 0) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "cython-src/_compreffor.pyx":1
 * from libc.stdint cimport uint32_t             # <<<<<<<<<<<<<<
 * from cpython cimport array
 * import array
 */
